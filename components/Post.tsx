    ...
    <Link href={`/blog/${data.id}`}>
      <a>
        <div className="h-64 w-96 rounded-xl bg-gray-200 duration-300 hover:scale-110">
          ...
          <div className="h-1/4">
            <div className="flex items-start justify-evenly pt-2">
            ...
            <div className="ml-3 mt-1 w-16 rounded-full bg-indigo-200 px-2 py-1 text-center text-xs text-indigo-500">
              {data.category}
            </div>
          </div>
